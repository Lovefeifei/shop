...
<table width="600" class="thin-border" align="center" class="thin-border">
	<tr>
	<td>用户名：</td><td><input type="text" name="username" value="${param.username}"/>
	<span class="errorContainer">${errors.username }</span></td>
	</tr>
	<tr>
	<td>用户密码：</td><td><input type="password" name="password" value="${param.password}" />
	<span class="errorContainer">${errors.password }</span></td>
	</tr>
	<tr>
	<td>用户昵称：</td><td><input type="text" name="nickname" value="${param.nickname}"/>
